                ...
                {activeTab === 'overview' && (
                    <div className="grid gap-6" style={{ gridTemplateColumns: 'repeat(auto-fit, minmax(350px, 1fr))' }}>
                        <div className="card space-y-5">
                            <h3 className="text-xl font-bold text-primary pb-2 border-b">Medical Information</h3>
                            <div className="space-y-4">
                                {[['Diagnosis', patient.diagnosis], ['Surgery', patient.surgeryType], ['Treatment', patient.treatmentSummary],
                                ['Admission', patient.admissionDate && new Date(patient.admissionDate).toLocaleDateString()],
                                ['Discharge', patient.dischargeDate && new Date(patient.dischargeDate).toLocaleDateString()]
                                ].map(([l, v]) => (
